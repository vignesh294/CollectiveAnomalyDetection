from keras.layers import Input, Dense, Conv1D, Dropout, MaxPooling1D, Flatten, BatchNormalization, Activation
...
class DeepCCA_cnn():
    def __init__(self, input_size1,
                 input_size2, outdim_size, reg_par, input_2d):
        self.input_size1 = input_size1
        self.input_size2 = input_size2
        self.outdim_size = outdim_size
        self.reg_par = reg_par

        self.input_view1 = tf.placeholder(tf.float32, [None, input_2d, input_size1])
        self.input_view2 = tf.placeholder(tf.float32, [None, input_2d, input_size2])
    ...
    def layers1(self):
        ...
        layer1_1 = Conv1D(filters=64, kernel_size=15, padding='same', strides=2)(input1)
        layer1_1 = BatchNormalization()(layer1_1)
        layer1_1 = Activation('relu')(layer1_1)
        layer1_3 = Conv1D(filters=128, kernel_size=15, padding='same', strides=2)(layer1_1)
        layer1_3 = BatchNormalization()(layer1_3)
        layer1_3 = Activation('relu')(layer1_3)
        layer1_3 = MaxPooling1D(2, strides=2)(layer1_3)
        """
        layer1_3 = Conv1D(filters=64, kernel_size=12, activation='relu')(layer1_3)
        layer1_3 = Conv1D(filters=64, kernel_size=12, activation='relu')(layer1_3)
        layer1_3 = Conv1D(filters=64, kernel_size=12, activation='relu')(layer1_3)
        """
        layer1_5 = Flatten()(layer1_3)
        layer1_6 = Dense(32, activation=tf.nn.relu, kernel_initializer=my_init_sigmoid, kernel_regularizer=l2(self.reg_par))(layer1_5)
        out1 = Dense(self.outdim_size, activation=None, kernel_initializer=my_init_others, kernel_regularizer=l2(self.reg_par))(layer1_6)
        return out1

    def layers2(self):
        input2 = self.input_view2
        layer2_1 = Conv1D(filters=64, kernel_size=15, padding='same', strides=2)(input2)
        layer2_1 = BatchNormalization()(layer2_1)
        layer2_1 = Activation('relu')(layer2_1)
        layer2_3 = Conv1D(filters=128, kernel_size=15, padding='same', strides=2)(layer2_1)
        layer2_3 = BatchNormalization()(layer2_3)
        layer2_3 = Activation('relu')(layer2_3)
        layer2_3 = MaxPooling1D(2, strides=2)(layer2_3)
        """
        layer2_3 = Conv1D(filters=64, kernel_size=12, activation='relu')(layer2_3)
        layer2_3 = Conv1D(filters=64, kernel_size=12, activation='relu')(layer2_3)
        layer2_3 = Conv1D(filters=64, kernel_size=12, activation='relu')(layer2_3)
        """
        layer2_5 = Flatten()(layer2_3)
        layer2_6 = Dense(32, activation=tf.nn.relu, kernel_initializer=my_init_sigmoid, kernel_regularizer=l2(self.reg_par))(layer2_5)
        out2 = Dense(self.outdim_size, activation=None, kernel_initializer=my_init_others, kernel_regularizer=l2(self.reg_par))(layer2_6)
        return out2
