...
parser.add_argument('--window-len', type=int, default = 125)
parser.add_argument('--output-dim', type=int, default = 25)
...
# new var - total data size
total_data_size = 12000

learning_rate = 0.01
momentum = 0.5
batch_size = 1024
num_sample = total_data_size - batch_len + 1
input_size1 = 3
input_size2 = 2
input_2d = batch_len
reg_par = 2
...
print('mean_out shape: ' + str(mean_out.shape))
print('output_free shape: ' + str(output_free.shape))
print('complex: ' + str(np.tile(mean_out, (num_sam, 1)).shape))
...
#         savemat('corr.mat', {'corr1':corr1, 'corr2':corr2})
        ...
        pt_num = total_data_size - batch_len + 1
