from keras.layers import Input, Dense, Conv1D, Dropout, MaxPooling1D, Flatten, BatchNormalization
...
class DeepCCA_cnn():
    ...
    def layers1(self):
        ...
        layer1_1 = Conv1D(filters=64, kernel_size=16, activation='relu')(input1)
        layer1_1 = BatchNormalization()(layer1_1)
        layer1_3 = Conv1D(filters=128, kernel_size=16, activation='relu')(layer1_1)
        ...
        layer1_6 = Dense(64, activation=tf.nn.relu, kernel_initializer=my_init_sigmoid, kernel_regularizer=l2(self.reg_par))(layer1_5)
    ...
    def layers2(self):
        ...
        layer2_1 = Conv1D(filters=32, kernel_size=16, padding='same')(input2)
        layer2_1 = BatchNormalization()(layer2_1)
        Activation
        layer2_3 = Conv1D(filters=128, kernel_size=16, padding='same')(layer2_1)
        ...
        layer2_6 = Dense(64, activation=tf.nn.relu, kernel_initializer=my_init_sigmoid, kernel_regularizer=l2(self.reg_par))(layer2_5)
